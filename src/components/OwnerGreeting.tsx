  ...
  return (
    <section className="relative min-h-[80vh] w-full">
      ...
      <div className="relative min-h-[80vh] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
        <div 
          ref={ref}
          className={`w-full md:w-1/2 lg:w-1/3 py-16 fade-in-section ${
            isInView ? 'is-visible' : ''
          }`}
        >
          ...
          <h2 className="text-3xl md:text-4xl font-karma mb-8 text-white">
          ...
          <div className="space-y-6 leading-relaxed text-white">
            ...
            <p className="text-xl font-karma text-hotel-gold italic">
          ...
          <div className="mt-12 font-karma">
            <p className="text-hotel-gold mb-1">Herzlichst,</p>
            <p className="text-lg text-white">Caroline von Kretschmann</p>
            <p className="text-sm italic text-hotel-gold mt-2">- Ihre Gastgeberin in vierter Generation</p>
          </div>
        </div>
      </div>
    </section>
